...
(function (i, V, l, n) {
    var j = function (e) {
        ...
        k.jqXHR = i.ajax({
            ...
            sInfoEmpty: "عرض 0 الي 0 من الإجمالي  ", sInfoFiltered: "(filtered from _MAX_ total entries)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Show _MENU_ entries", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "البحث :", sUrl: "", sZeroRecords: "لا توجد نتائج بحث"
